...
# ==============================================================================
# КАЛИБРОВКА ПРОЕКЦИИ (твои значения)
# ==============================================================================
# Эти оффсеты компенсируют рассинхрон скриншота и координат
# Получены экспериментально для идеального наложения
OFFSET_X = 75    # Сдвиг по горизонтали (+ = вправо)
OFFSET_Y = 250   # Сдвиг по вертикали (+ = вниз)
